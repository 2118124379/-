...
def train(attr_input, topic_input, sketch_output, review_input, review_output, mask, encoder, birnn_encoder, review_decoder, 
    ...
    # review decoder
    review_decoder_output, review_decoder_hidden, _ = review_decoder(review_decoder_input, review_decoder_hidden, topic_input, encoder_out)
...
def evaluate(attr_input, topic_input, sketch_output, review_input, review_output, mask, encoder, birnn_encoder, review_decoder, 
            encoder_optimizer, birnn_encoder_optimizer, review_decoder_optimizer, output_blue=False):
    ...
    # review decoder
    review_decoder_output, review_decoder_hidden, _ = review_decoder(review_input, review_decoder_hidden, topic_input, encoder_out)
        ...
        if not best_val_loss or vl_loss < best_val_loss:
            ...
            for test_batch in test_batches:
                ...
                if review_input.size(0) > 100:
                    los_num += 1
                    continue
                loss,blue_score = evaluate(attr_input, topic_input, sketch_output, review_input, review_output, mask, encoder, birnn_encoder, review_decoder,
                            encoder_optimizer, birnn_encoder_optimizer, review_decoder_optimizer,output_blue=True)
